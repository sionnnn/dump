...
module.exports = yeoman.generators.Base.extend({
  ...
  writing: function(){
    ...
    installGruntDependencies([this.preOpsFeatures,this.jsFeatures,this.cssFeatures,this.htmlFeatures,this.iconsFeatures,this.imagesFeatures,this.docsFeatures])
